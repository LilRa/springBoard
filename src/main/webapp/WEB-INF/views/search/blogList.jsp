                        ...
                        <div class="box-header with-border">
                            ...
                            <br><br>
	                           <!-- search form (Optional) -->
				                    <div id="search">
				                    	<select  id="searchKey" name="searchKey" height="3px">
				                    		<option value="blog">블로그</option>
				                    		<option value="news">뉴 스</option>
				                    		<option value="movie">영 화</option>
				                    	<input type="text" id="searchWord" placeholder="Search..." onkeyup="enterKey();">
				                        <span>
				                            <button id="searchBtn" class="btn btn-flat"><i class="fa fa-search"></i></button>
				                        </span>
				                    	</select>
				                    </div>
                        </div>
