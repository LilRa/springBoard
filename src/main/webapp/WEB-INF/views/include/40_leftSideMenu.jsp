        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href='<c:url value="/search/searchBlog"/>'><i class="fa fa-th-list"></i> <span>블로그 검색</span></a></li>
                    <li><a href='<c:url value="/reply/boardList"/>'><i class="fa fa-th-list"></i> <span>게시판 댓글</span></a></li>
                    <li><a href='<c:url value="/upload/uploadPage"/>'><i class="fa fa-th-list"></i> <span>게시판 파일 업로드</span></a></li>
