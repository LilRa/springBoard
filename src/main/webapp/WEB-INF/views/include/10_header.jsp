            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                    	...
                    	<!-- sign in -->
                    	<li>
                            <a href='<c:url value='/secu/loginPage'/>'>Sign in</a>
                        </li>
                        <!-- sign up -->
                        <li>
                            <a href='<c:url value='/register/terms'/>'>Sign up</a>
                        </li>
                        <!-- User Account Menu -->
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href='<c:url value='/secu/loginPage'/>' class="btn btn-default btn-flat">Sign in</a>
                                    </div>
